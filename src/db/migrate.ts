 ...
 * always up-to-date before the server starts accepting requests.  The
 * migration is intentionally simple (no versioned migration table) because
 * the canary fixture only needs a stable schema, not a full migration history.
 */
