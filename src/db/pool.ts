...
// We use a dynamic import for `pg` so that:
//   a) The module compiles even when the package is not yet installed.
//   b) Tests can mock the pool without triggering a real connection attempt.
